export default {
    ...
    prompt: {
        questions: {
            ...
            scope: {
                description: '此更改的范围是什么(例如组件或文件名): (按 Enter 键跳过)',
            },
            subject: {
                description: '对变化写一个简短的、命令式的描述:\n',
            },
            body: {
            ...
            breakingBody: {
                description: '一个 BREAKING CHANGE 提交需要一个 body。请输入对提交本身的更长描述:\n',
            },
            breaking: {
                description: '描述破坏性变化:\n',
            },
            ...
            issuesBody: {
                description: '如果 issues 已关闭，则提交需要一个 body。请输入对提交本身的更长描述:\n',
            },
            issues: {
